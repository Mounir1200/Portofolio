...
export function Hero() {
  return (
    <section id="profil" className="mt-8 flex min-h-[70vh] w-full flex-col items-center justify-center gap-10 md:mt-12 lg:flex-row lg:gap-12">
      ...
      <div className="relative w-full max-w-[18rem] flex-1 sm:max-w-sm lg:max-w-md">
        <motion.div 
          initial={{ x: 100, opacity: 0 }}
          animate={{ x: 0, opacity: 1 }}
